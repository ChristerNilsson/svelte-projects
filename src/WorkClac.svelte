...
<div id="clac" class="work">

	<!-- Title -->
	<div class="clac full-size">
		<h2>
			Certains L'Aiment Chaud <span>Female jazz band</span>
		</h2>
	</div>

	<!-- Desc -->
	<div id="clac-desc" class="clac desc">
		<h3>Certains L'Aiment Chaud</h3>
		<p>
			Lorem Salu bissame&nbsp;! Wie geht's les samis&nbsp;? Hans apporte moi une Wurschtsalad
	...
	<!-- Link -->
	<div class="clac site-link">
		<h4>visit site</h4>
		<h5>
			<a href="https://certainslaimentchaud.com/">certainslaimentchaud.com</a> | 2019
		</h5>
	</div>

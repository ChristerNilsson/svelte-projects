...
<div id="ad" class="work">

<!-- Title -->
<div class="ad full-size">
	<h2>
		Alexandre Desplat <span>Film music composer</span>
	</h2>
</div>

<!-- Desc -->
<div id="ad-desc" class="ad desc">
	<h3>Alexandre Desplat</h3>
	<p>
...
<!-- Link -->
<div class="ad site-link">
	<h4>visit site</h4>
	<h5>
		<a href="https://www.alexandredesplat.net">alexandredesplat.net</a> | 2018
	</h5>
</div>

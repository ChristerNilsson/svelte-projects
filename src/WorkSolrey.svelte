...
<!-- Title -->
<div class="solrey full-size">
	<h2>
		Solrey <span>Producer, stage director, violinist</span>
	</h2>
</div>

<!-- Desc  -->
<div id="solrey-desc" class="desc">
	<h3>Solrey</h3>
	<p>
...
<!-- Links -->
<div class="solrey site-link">
	<h4>visit site</h4>
	<h5>
		<a href="https://solrey.fr/">solrey.fr</a> | 2019
	</h5>
</div>
